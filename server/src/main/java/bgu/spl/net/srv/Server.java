...
public interface Server<T> extends Closeable {
     ...
     * @param protocolFactory A factory that creates new MessagingProtocol
     ...
     * @param port The port for the server socket
     * @param protocolFactory A factory that create new MessagingProtocol
     * @param encoderDecoderFactory A factory that create new MessageEncoderDecoder
     * @param <T> The Message Object for the protocol
